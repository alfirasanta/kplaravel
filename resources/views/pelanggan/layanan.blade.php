                    ...
                    <div class="row g-0">
                        <div class="col-3">
                            <div class="list-group">
                                ...
                                <button type="button" class="list-group-item list-group-item-action">Internet
                                    Bisnis</button>
                                <button type="button"
                                    class="list-group-item list-group-item-action">Operasional</button>
                                <button type="button" class="list-group-item list-group-item-action">SDM</button>
                                <button type="button" class="list-group-item list-group-item-action">Pemasaran</button>
                            </div>
                        </div>
